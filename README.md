...
no scripting, every frame generated by the model. Sudden switches in the scene are
usually me loading new seeds.

<table>
  <tr>
    <td width="33.333%" align="center"><img src="assets/demo.gif" alt="Live play: a person drives Link around the overworld with the arrow keys; every frame is generated by the model."></td>
    <td width="33.333%" align="center"><img src="assets/showcase/combat.gif" alt="Live unscripted play at the world's edges"></td>
    <td width="33.333%" align="center"><img src="assets/showcase/stress.gif" alt="Live unscripted overworld play"></td>
  </tr>
  <tr>
    <td width="33.333%" align="center"><em>Live keyboard play. Seeded from one real frame; every frame after that is dreamed by the model in response to input.</em></td>
    <td width="33.333%" align="center"><em>Held against the world's edges — geometry phases and warps. An honest look at how the dream breaks down.</em></td>
    <td width="33.333%" align="center"><em>A normal stretch of live overworld play.</em></td>
  </tr>
</table>
